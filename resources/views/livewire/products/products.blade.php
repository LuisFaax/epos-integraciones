                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"
                                                ...
                                                <a class="dropdown-item" href="#"
                                                    wire:click.prevent="viewProduct({{ $item->id }})"><i
                                                        class="las la-eye la-2x"></i> View</a>
                                                <a class="dropdown-item" href="#"
                                                    wire:click.prevent="Edit({{ $item->id }})"><i
                                                        class="las la-pen la-2x"></i> Edit</a>
                                                <a class="dropdown-item" href="#"
                                                    onclick="Confirm('products',{{ $item->id }})"><i
                                                        class="las la-trash-alt la-2x"></i> Delete</a>
                                                @if($item->platform_id == null)
                                                <a class="dropdown-item save" href="#"
                                                    wire:click.prevent="Sync({{ $item->id }})"><i
                                                        class="las la-sync la-2x"></i> Sync</a>
                                                @endif
                                            </div>
                                        </div>
                                    </td>
